          ...
          <div className="lg:col-span-2">
            ...
            <div>
              <button
                disabled={
                  cartItems.findIndex(
                    (cartItems) => cartItems.id === productDetails?.id
                  ) > -1
                }
                onClick={() => handleAddToCart(productDetails)}
                className=" disabled:opacity-40 mt-5 min-w-[200px] px-4 py-3 border border-[#333] bg-transparent text-sm font-semibold rounded"
              >
                Add to Cart
              </button>
            </div>
